...
protected:
	...
	virtual void OnSend(int32 contentsByteSize, int32 id);
	UFUNCTION(BlueprintImplementableEvent, Category = "TCPSession", meta = (DisplayName = "OnSendPacket"))
	void OnSendBP(int32 id, int32 contentsByteSize);
	...
	virtual void SendMessageCallback(int32 BytesTransferred, int32 id);
